...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rflod38.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rflod38.containers.anotherwebservice.com/
...
```
git clone git@github.com:shuvarek/container-rflod38.git
cd container-rflod38
```
...
```
docker attach container-rflod38
```
